 ...
 */
export function showCircleScan(viewer, lon, lat,scanColors, maxRadius,duration) {
    var cartographicCenter = new Cesium.Cartographic(Cesium.Math.toRadians(lon), Cesium.Math.toRadians(lat), 32);
    //var scanColor = new Cesium.Color(0.0, 1.0, 0.0, 1);
    //var scanColor = Cesium.Color.DARKORANGE;
    var scanColor = scanColors;
    lastStage = addCircleScanPostStage(viewer, cartographicCenter, maxRadius, scanColor, duration);
}
 ...
 * @param radius  扫描半径
 */
export function showRadarScan(viewer, lon, lat, radius) {
    var cartographicCenter = new Cesium.Cartographic(Cesium.Math.toRadians(lon), Cesium.Math.toRadians(lat), 32);
...
export function clearRadarScan(viewer) {
    // 清除
