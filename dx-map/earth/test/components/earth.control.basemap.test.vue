<template>
  <div>
    <MyEarth ref="earthCom" style="width: 1500px; height: 800px">
      <MyEarthBasemap></MyEarthBasemap>
    </MyEarth>
  </div>
</template>
...
import MyEarthBasemap from "@earth/components/my-earth-control/MyEarthBasemap";
